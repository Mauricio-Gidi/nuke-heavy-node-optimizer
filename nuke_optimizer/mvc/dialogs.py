"""Small wrapper around QMessageBox dialogs used by the UI."""

from __future__ import annotations

from typing import Optional

# Qt binding compatibility (PySide2 / PySide6) is provided by mvc/qt_compat.py.
...
class DialogService:
    ...
    def ask_yes_no(
        ...
        """
        clicked_button = QtWidgets.QMessageBox.question(
            parent,
            title,
            text,
            _YES | _NO,
