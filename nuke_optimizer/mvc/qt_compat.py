"""Qt binding compatibility shim for Nuke (PySide2/Qt5 and PySide6/Qt6).

Nuke 13.x ships with Qt5/PySide2 (Python 3.7), while Nuke 16+ ships with
Qt6/PySide6. This module provides a single import location and a small set
of constants/helpers to smooth over the most common API differences used by
this repo (enums, flags, and a few moved classes).

Keep this module intentionally small:
- No UI logic.
- No Nuke imports.
- Only compatibility glue and constants.
"""
